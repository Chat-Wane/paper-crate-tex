...
\newcommand\ADDY{-10};
  ...
  \draw[->,densely dashdotted](-50pt,\ADDY + \Y pt)--(-50pt,2.75*\ADDY+\Y pt);
  \draw[->,densely dashdotted](-30pt,\ADDY + \Y pt)--(-30pt,2.75*\ADDY+\Y pt);
  \draw[->,densely dashdotted](-10pt,\ADDY + \Y pt)--(-10pt,2.75*\ADDY+\Y pt);
  \draw[->,densely dashdotted]( 10pt,\ADDY + \Y pt)--( 10pt,2.75*\ADDY+\Y pt);
  \draw[->,densely dashdotted]( 30pt,\ADDY + \Y pt)--( 30pt,2.75*\ADDY+\Y pt);
  \draw[->,densely dashdotted]( 50pt,\ADDY + \Y pt)--( 50pt,2.75*\ADDY+\Y pt);
  ...
  \draw[->,densely dashdotted](-45pt,-102pt) -- (-35.5pt,-102pt);
  \draw (0pt,-102pt) node[anchor=east]{function $\delta$};
  \draw[fill=gray!20](3.5pt,-102pt) node[anchor=west]{\ disambiguator}
  +(-2.5pt,-2.5pt)  rectangle +(2pt,2pt);
