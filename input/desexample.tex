...
\newcommand\ADDY{-10};
  ...
  %% node to node
  \small
  \draw[dashed,thick] (0pt,0pt) -- node[anchor=south east]{0} (-75pt,\Y pt);
  ...
  \draw[dashed,thick] (0pt,0pt) -- node[anchor=south west]{9} ( 75pt, \Y pt);
  ...
  \draw[fill=black] (-75pt, \Y pt) circle (1pt); 
  ...
  node{$\langle u_1,\, 6\rangle$}
  +(-12pt,-4pt) rectangle +(12pt,4pt);
  \draw[fill=gray!20] ( 15pt,-2.5+2.75*\ADDY+2*\Y pt)
  node{$\langle u_1,\, 6\rangle\langle u_1,\,7\rangle$}
  +(-22pt,-4pt) rectangle +(22pt,4pt);
  \draw[fill=gray!20] ( 30pt,-2.5+2.75*\ADDY+\Y pt)
  node{$\langle u_2,\, 1\rangle$}
  +(-12pt,-4pt) rectangle +(12pt,4pt);
  \draw[fill=gray!20] ( 50pt,-2.5+2.75*\ADDY+\Y pt)
  +(-2.5pt,-2.5pt) rectangle +(2.5pt,2.5pt);
  ...
  \begin{scope}[shift={(-70pt, 2.5*\Y pt)}]    
