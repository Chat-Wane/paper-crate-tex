...
efficient. Nonetheless, based on preferences, one could choose a flattened tree
representation to improve the performance of operations at the cost of increased
memory usage.  Section~\ref{sec:experiments} validates our complexity analysis
on experiments. The next section describes the other components necessary to
build a decentralized collaborative editor that scales.
