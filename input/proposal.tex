...
new path between [$4$] and [$5$], but there are 7 available paths between
[$4.2$] and [$5.0$]. Thus, the new path will comprise 2 concatenations: [$4.X$]
where $X$ is yet to determine.

\noindent Secondly, a hash function $h$ delegates the choice to a sub-allocation
function. \TODO{Here.}
