...
\item Intention preservation: effects observed at generation time must be
  re-observed at integration time regardless of concurrent operations. Intention
  of operations should follow their sequential
  specification~\cite{bieniusa2012brief}.
\end{itemize}
...
% The commutative property of operations ensures the consistency of the system.
