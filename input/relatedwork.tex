...
operations~\cite{sun1998achieving}. \TODO{Consistency finally requires
...
\item [Operational transformation] (OT) allows building both centralized and
  ...
  grows and \TODO{becomes less predictable}.
...
\item [Variable-size identifiers] CRDTs truly destroy elements targeted by
  ...
  size $\mathcal{O}((\log I)^2)$. \TODO{Section~\ref{subsec:sequence} describes its
  functioning.} In this paper, we demonstrate this upper-bound and we state the
