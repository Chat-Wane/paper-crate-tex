...
\begin{abstract}
  WebRTC provides browser-to-browser connections. It allows a new kind
  of web applications to run distributed across browsers without the
  need of web servers.  Such applications are easy to deploy, better
  preserve privacy and should scale at the web-scale.

  In this paper, we present CRATE a browser-to-browser real-time
  editor. Building such applications requires component to ensure
  communications and consistency.

  As core components, \CRATE uses \LSEQ to efficiently
