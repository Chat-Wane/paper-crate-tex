\begin{abstract}
  ...
  documents. if currently real-time editors is mainly used by small
  ...
  communication complexities.  In this paper, we propose \CRATE; a
  decentralized real-time editor that supports large number of users
  working on large documents. Thanks to WebRTC, \CRATE can be easily
  deployed on a network of browsers i.e. without servers.
