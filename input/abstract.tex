...
% http://www.easterbrook.ca/steve/2010/01/how-to-write-a-scientific-abstract-in-six-easy-steps/ to structure the abstract
  ...
  runs on a network of browsers i.e. without servers. We balanced
  complexities in order to support large number of users working on
  large document. We extensively describe each core components, we
  provide the proof of the polylarithmic upper-bound on the space
  complexity of the shared sequence. We evaluate \CRATE in large-scale
  experiments on the Grid'5000 testbed until 500 participants. We
  observed logarithmic progession of generated traffic according the
