...
% 
  ...
  that supports large number of users working on large documents.
  \TODO{ \CRATE is based on a replicated sequence data structure the
    size of which grows sublinearly and solely for insertions without
    impacting time and communication complexities.}  Thanks to WebRTC,
  \CRATE can be easily deployed on a network of browsers i.e. without
  servers.
%4
