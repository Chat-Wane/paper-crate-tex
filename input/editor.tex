...
\TODO{\CRATE is a real-time decentralized editor running directly within
...
complexity scales well in terms of number of participants and document size.
}
% The rest of this section describes each layer with more details. In particular,
% it describes the series of components that build \TODO{In this paper we show how
%   the adaptivity of the membership protocol \SPRAY impacts the traffic of the
%   real-time editor \CRATE. We demonstrate the upper bounds of space and time
%   complexities of \LSEQ and the conditions under which it applies. We validate
%   experimentally the aforementioned analysis.}
